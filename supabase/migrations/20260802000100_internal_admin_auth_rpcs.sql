...
as $$
  select jsonb_build_object(
    ...
    'gender', p_internal_admin.gender,
    'email', p_internal_admin.email,
    'contact_number', p_internal_admin.contact_number,
    'address_line', p_internal_admin.address_line,
    'city', p_internal_admin.city,
    'province', p_internal_admin.province,
    'postal_code', p_internal_admin.postal_code,
    'emergency_contact_name', p_internal_admin.emergency_contact_name,
    'emergency_contact_relationship', p_internal_admin.emergency_contact_relationship,
    'emergency_contact_number', p_internal_admin.emergency_contact_number,
